...
`https://generativelanguage.googleapis.com/v1/models/gemini-2.5-flash:generateContent?key=${apiKey}`,        {
          ...
          body: JSON.stringify({
            contents: [{
              parts: [
                {
                  text: "Extract ALL visible Python code from this screenshot exactly as shown (preserve indentation and formatting). Then explain it line-by-line in clear, simple language. Focus ONLY on the code — no intro, no summary, no extra concepts. Start directly with the code block."
                },
...
//working but still verbose version